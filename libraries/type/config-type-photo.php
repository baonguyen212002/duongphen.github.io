...
/* img-intro*/
$nametype = "img-intro";
$config['photo']['photo_static'][$nametype]['title_main'] = "Giới thiệu";
$config['photo']['photo_static'][$nametype]['images'] = true;
$config['photo']['photo_static'][$nametype]['width'] = 285;
$config['photo']['photo_static'][$nametype]['height'] = 220;
$config['photo']['photo_static'][$nametype]['thumb'] = '285x220x1';
$config['photo']['photo_static'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';
/* Slideshow */
