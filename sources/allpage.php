<?php
    ...
    $splistmenu_nb = $d->rawQuery("select ten$lang, tenkhongdauvi, id,photo from #_product_list where type = ? and noibat > 0 and hienthi > 0 order by stt,id desc",array('san-pham'));
