    ...
    <div class="wrap_detail">
        <div class="grid-pro-detail w-clear">
            ...
            <div class="right-pro-detail w-clear">
                <h1 class="title-pro-detail"><?= $row_detail['ten' . $lang] ?></h1>
                ...
                <div class="cart-mobile flex-center-left">
                    <li class="w-clear">
                        <div class="attr-content-pro-detail">
                    ...
                    <li class="w-clear border-top-0">
                        <a data-toggle="modal" class="muangay1 addcart" data-action="addnow" data-id="<?= $row_detail['id'] ?>" data-name="<?= $row_detail['tenvi'] ?>" data-gia="<?= $func->format_money($row_detail['gia']) ?>" href="#popup-detail"><i class="fal fa-shopping-cart"></i> Thêm vào giỏ</a>
                    </li>
                    <li class="w-clear border-top-0"><a class="muangay2 addcart" data-action="buynow" data-id="<?= $row_detail['id'] ?>" data-name="<?= $row_detail['tenvi'] ?>" data-gia="<?= $func->format_money($row_detail['gia']) ?>">Mua ngay</a></li>
                </div>
                <div class="desc-pro-detail">
                    <?= (isset($row_detail['mota' . $lang]) && $row_detail['mota' . $lang] != '') ? htmlspecialchars_decode($row_detail['mota' . $lang]) : '' ?>
                </div>
                <ul class="cart flex-center-left">
                    <li class="w-clear">
